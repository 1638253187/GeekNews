...
public class SystemUtil {
    ...
    public static boolean isWifiConnected() {
        ConnectivityManager connectivityManager = (ConnectivityManager) GeekApplication.getApp().getSystemService(Context.CONNECTIVITY_SERVICE);
    ...
    public static int dp2px(float dpValue) {
        final float scale = GeekApplication.getApp().getResources().getDisplayMetrics().density;
        return (int) (dpValue * scale + 0.5f);
    }
